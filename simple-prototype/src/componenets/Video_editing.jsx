...
const steps = [
  {
    label: 'Choose Your Device: Phone, Tablet, or Computer',
    description: `There are two kinds of softwares available : Paid and Free(choose)
                1st Kind: chose Paid one direct to the next step.
                3nd Kind : Kind of people they have to use paid with the tricks legal direct way and if its illegal have to get another ways ie.Hints to Direct him to the right source
              `,
  },
  {
    label: 'Computer',
    description:
      'Firstly we can help them to buid the environment by the related tags that are usefull to them',
  },
  {
    label: 'Action',
